...
#define FILE_STATS_NAME     "stats_agnostic"
#define FILE_OTHERS         "others_agnostic"
#define FILE_OUPUT_NAME     "output_agnostic"
...
using chunkT            = chunk<double, tuple_t, vector<tuple_t>>;
using queueType         = fqueue<double, tuple_t, vector<tuple_t>>;
using FUN_ITERATOR_TYPE = queueType::iterator;

#include "Win_WF_function.hpp"
#include "Win_WF_Collector.hpp"
#include "Win_WF_sw.hpp"
#include "Win_WF_agnostic_structure.hpp"
